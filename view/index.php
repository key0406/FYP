...
<body>
  <div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <!--<p class="mb-1">Choose your language</p>-->
      ...
      <div class="survey">
        ...
        <h3>Upload picture of your Knee</h3>
        <p>※This helps doctor to check your knee status but this is not mandatory field
          <br>Also, upload the file with png or jpeg format please.
        </p>
